...
if (isset($_POST['product_delete'])) {
    $order_id = mysqli_real_escape_string($con, $_POST['product_delete']);
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $contact_query = "SELECT * FROM orders"; // Replace 'contact_us' with your actual table name
                                            ...
                                            foreach ($contact_run as $contact) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($contact['phone']) ?></td>
                                                         <td><?= htmlspecialchars($contact['product']) ?></td>
                                                              <td><?= htmlspecialchars($contact['quantity']) ?></td>
                                                                   <td><?= htmlspecialchars($contact['payment_mode']) ?></td>
