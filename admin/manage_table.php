...
if (isset($_POST['product_delete'])) {
    $tablebooking_id = mysqli_real_escape_string($con, $_POST['product_delete']);
    $delete_query = "DELETE FROM table_booking WHERE id = '$tablebooking_id'";
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $contact_query = "SELECT * FROM table_booking"; // Replace 'contact_us' with your actual table name
                                        ...
                                        if ($contact_run === false) {
                                            ...
                                            foreach ($contact_run as $contact) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($contact['table_no']) ?></td>
                                                    <td><?= htmlspecialchars($contact['time']) ?></td>
                                                    <td><?= htmlspecialchars($contact['people']) ?></td>
                                                    <td><?= htmlspecialchars($contact['product_name']) ?></td>
                                                      <td>
                                                        <form action="" method="POST" onsubmit="return confirm('Are you sure you want to delete this table booking?');">
